<template>
  <!-- <div class="mapdiv" :id="mapId" style="height: 500px; width: 100%"></div> -->
  <!-- <div>
    <div id="da" ref="MapMountNode"></div>
  </div> -->
  <div id="SGbaidumap">
    <div id="MapChart" ref="MapChart" style="width: 100%; height: 400px"></div>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    // initMap() {
    //   map('ruaXitVK04sUgLIra8h159y3g7KvA8rB')
    //     // .then(() => {
    //       // 百度地图API功能
      ...
      var option = {
        ...
        tooltip: {
          ...
          formatter: function (p) {
            console.log(p)
            var text = p.data.name + "设备数量:" + p.data.value[2]
            return text
          },
        },
        bmap: {
